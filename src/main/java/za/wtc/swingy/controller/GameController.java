...
public class GameController {
    ...
    public static void moveHero(int direction) {
        ...
        if (map.getMap()[hero.getXCoordinate()][hero.getYCoordinate()] == 'X') {
            ...
            if (random == 2) {
                enemy = (Enemy) HeroFactory.newEnemy(hero, HeroEnum.DRAGON);
            } else {
                enemy = (Enemy) HeroFactory.newEnemy(hero, HeroEnum.BIGFOOT);
            }
    ...
    /**
     * Engages the Hero in a battle with the enemy. If the hero ran and the odds
     */
    ...
    /**
     * The hero wins if he reaches one of the borders of the map.
     */
    public static void goal() {
        if (hero.getXCoordinate() == map.getSize() - 1 ||
            ...
            hero.getYCoordinate() == 0) {
                log(ANSI_CYAN + "::: Congratulations, You Reached Your Goal!" + ANSI_RESET);
